...
const Launch = props => {
    ...
    const [ deleteLaunch, { test }] = useMutation(DELETE_LAUNCH,{ variables : { flight_number}});
                ...
                <>     
                    {
                        ...
                        <>
                            ...
                            <div className="mt-5">
                                <button className="btn btn-danger mx-3" onClick={handleDeleteLaunch}>Delete Launch</button>
